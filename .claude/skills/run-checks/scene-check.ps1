...
if (-not $godot) { throw "Godot .NET binary not found — add the Godot_*_console.exe directory to your user PATH (see README or godot-binary-for-headless-checks memory)" }
